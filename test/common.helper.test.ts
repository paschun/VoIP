...
describe('combineURLs', () => {
    test.each([
        { segments: ['https://api.telnyx.com', 'api/call/telnyx'], expected: 'https://api.telnyx.com/api/call/telnyx', name: 'joins a host and a path with one slash' },
        { segments: ['https://api.telnyx.com/', '/api/call'], expected: 'https://api.telnyx.com/api/call', name: 'collapses the trailing+leading slash at a seam' },
