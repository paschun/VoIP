...
// Routes for `/api/email`. Methods are chained and each controller export is a `factory.createHandlers(...)` array
// spread in -- chaining + spreading is what lets RPC infer the group's types.
